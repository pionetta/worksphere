...
export function SidebarNavigation({ onLogout }: { onLogout?: () => void }) {
  return (
    <nav
    ...
    >
      ...
      {onLogout && (
        <div className="p-3 border-t border-gray-200 dark:border-gray-700">
          <button
            onClick={onLogout}
            className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl text-sm font-medium text-danger hover:bg-danger-light/30 dark:hover:bg-red-900/30 transition-colors"
          >
