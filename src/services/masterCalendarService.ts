  ...
  for (const d of debts) {
    ...
    if (d.is_installment && d.installment_due_day) {
      ...
      events.push({
        ...
        module: 'finance',
        type: 'debt',
        title: `${d.is_flexible_installment ? 'Tagihan Paylater' : 'Cicilan'} ${d.person_name} (Tgl ${d.installment_due_day})`,
        date: installmentDate,
        amount: d.current_bill_amount || d.installment_amount || (d.amount - d.paid_amount),
        status: d.status,
