...
async function capture() {
  ...
  await page.screenshot({ path: path.join(outDir, 'finance_streamlined_dark.png') });
  ...
  await new Promise(r => setTimeout(r, 500));
  await page.screenshot({ path: path.join(outDir, 'finance_streamlined_light.png') });

  await browser.close();
  console.log('Finance streamlined screenshots captured!');
}
